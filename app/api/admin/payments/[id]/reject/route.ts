...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      const webhookResponse = await fetch(`${webhookUrl}/webhook-test/payment-rejected`, {
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({
          metadata: {
            ...
            source: 'admin-payment-rejection',
          ...
          notificationTargets: {
            // Notify user that payment was rejected with reason
            user: true,
            // Notify admins
            admin: true,
          },
