      ...
      try {
        ...
        if (response.ok && data.event) {
          ...
          setFormData({
            ...
            baslangic_tarihi: formatDateForInput(event.baslangic_tarihi),
            bitis_tarihi: formatDateForInput(event.bitis_tarihi),
            ...
            erken_kayit_tarihi: formatDateForInput(event.erken_kayit_tarihi),
          });
        } else {
