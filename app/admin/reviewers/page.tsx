...
import { UserCheck, ArrowLeft, UserPlus, Mail, Calendar, Eye, FileText } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Bildiri hakem atamalarını yönetin</p>
              </div>
            </div>
            <Link
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="text-sm text-gray-600">Aktif Hakem</div>
            <div className="text-2xl font-bold text-green-600 mt-1">{stats.active}</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="text-sm text-gray-600">Şifre Değiştirmedi</div>
            <div className="text-2xl font-bold text-yellow-600 mt-1">{stats.firstLogin}</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <div className="text-sm text-gray-600">Toplam Atama</div>
            <div className="text-2xl font-bold text-purple-600 mt-1">{stats.totalAssignments}</div>
          </div>
        </div>
