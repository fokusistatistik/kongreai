        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Yeni Hakem</h1>
                <p className="text-gray-600 mt-1">Sisteme yeni hakem ekleyin</p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-6 border-t">
              ...
              <button
                type="submit"
                disabled={loading}
                className="inline-flex items-center gap-2 px-6 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors disabled:bg-purple-400 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
