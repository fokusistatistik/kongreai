        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mb-6 md:mb-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Yeni Kullanıcı</h1>
                <p className="text-gray-600 mt-1 text-sm md:text-base">Sisteme yeni kullanıcı ekleyin</p>
              </div>
            </div>
          </div>
